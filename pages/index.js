...
export default function Home() {
    return <RootLayout>
        <div className="">
            <h1 className="text-5xl mt-32 mb-10 font-bold text-center max-w-6xl mx-auto px-4 pl-40">Welcome to My Developer Portfolio</h1>
            <section className="max-w-6xl mx-auto px-4 pl-40">
                <h4 className="text-xl mt-10 mb-10 font-bold text-center">About Me</h4>
            ...
            <h4 className="text-xl mt-10 mb-10 font-bold text-center max-w-6xl mx-auto px-4 pl-40">Technologies I have experience in</h4>
            <div className="flex justify-between items-center max-w-4xl mx-auto px-4 pl-40">
                <FaHtml5 size="40" color={"#E34F26"}/>
                <FaCss3Alt size="40" color={"#1572B6"}/>
                <SiJavascript size="40" color={"#f8c41b"}/>
                <FaReact size="40" color={"#61DBFB"}/>
                <SiNextdotjs size="40" color={"#000000"}/>
                <SiTailwindcss size="40" color={"#38B2AC"}/>
            </div>
            <div className="pt-40 max-w-6xl mx-auto px-4 pl-40">
                <VerticalTimeline>
                    ...
                    >
                        <h3 className="vertical-timeline-element-title">Bachelor of Engineering, Mechanical Engineering</h3>
